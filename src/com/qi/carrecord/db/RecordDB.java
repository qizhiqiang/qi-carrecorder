...
public class RecordDB extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_SETTING = "create table T_B_SETTING(id integer primary key autoincrement,recording int default 1,split_video integer default 5,start_video int default 0,usb_state integer default 0)";
    private static final String name = "RecordDB";
    private static final int version = 0x1;
    
    public RecordDB(Context context) {
        super(context, "RecordDB", null, 0x1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table T_B_SETTING(id integer primary key autoincrement,recording int default 1,split_video integer default 5,start_video int default 0,usb_state integer default 0)");
