    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runnable = new Runnable(){
			...
			public void run() {
				...
				TranslateAnimation ta = new TranslateAnimation(1,0,1,-0x4080,1,0,1,0);
				ta.setDuration(0x3a98);
				animationSet1.addAnimation(ta);
				animationSet1.setFillAfter(true);
				TranslateAnimation ta1 = new TranslateAnimation(1,0x3f80,1,0,1,0,1,0);
				ta.setDuration(0x3a98);
				...
				imageView.setBackgroundColor(images[count%2]);
				count = count + 1;
				
				imageView2.setBackgroundColor(images[count%2]);
